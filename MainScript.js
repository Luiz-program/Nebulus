...
function setBackgroundColor() {
        ...
        img.onload = function() {
            ...
            const buttons = document.getElementsByClassName('button');
            for (let i = 0; i < buttons.length; i++) {
                buttons[i].style.background = rgb;
            }
            ...
            document.getElementById('msgartist').style.color = rgb;
            document.getElementById('credits').style.color = rgb;
...
if (musica === '1') {
    ...
    document.getElementById('musiclogo').src = "https://th.bing.com/th/id/OIP.eieU2Pf0CBzvtdR_L74OdQHaHa?rs=1&pid=ImgDetMain"; // Foto da música
    ...
    document.getElementById('musiclogo').src = "https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/70/7f/d9/707fd990-ab03-c28a-ee1d-9005ac77ed58/artwork.jpg/1200x1200bf-60.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    ...
    document.getElementById('musiclogo').src = "https://m.media-amazon.com/images/I/51+lpcg-DGL._UXNaN_FMjpg_QL85_.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    audio.addEventListener('timeupdate', function() {
        ...
        document.getElementById("lyrics").innerHTML = texto;
        document.getElementById('musicname').textContent = "Forever";
        ...
        document.getElementById('musiclogo').src = "https://i1.sndcdn.com/artworks-dBPml1DnccTWMjZS-ASdDzw-t500x500.jpg"; // Foto da música
        document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
        document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
        ...
        document.getElementById('sobre').style.backgroundImage = "url('')"; // Foto do artista
        document.getElementById('video-background').src = 'Material/Murder Drones OST FOREVER (Full Version).mp4';
        mudarFundo('musica4');
    ...
    // Muda para a primeira música
    let texto = "<strong>Letra não disponivel ainda!</strong>";
    ...
    document.getElementById('musiclogo').src = "https://i.scdn.co/image/ab67616d0000b273ad7bf73940435123b3435cd2"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://i1.wp.com/fontmeme.com/images/undertale-font.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/c3/3d/f1/c33df11e-1244-3f80-672c-9b7f88010f17/1963620475841_cover.jpg/1200x1200bf-60.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://th.bing.com/th/id/OIP.AmxNW-rgvql7A3YL2ZHSLQHaHa?w=151&h=180&c=7&r=0&o=5&pid=1.7"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    document.getElementById('artistimg').src = "https://global-uploads.webflow.com/62158cc7e1cd8f0ec3729390/63ee72e0ca97ba6cc54fd005_oneheart-wFp7E.jpeg"; // Foto do artista
    document.getElementById("lyrics").innerHTML = texto;
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://i.scdn.co/image/ab67616d0000b273e4d00d731d05f45d8026628c"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://i.scdn.co/image/ab67616d0000b273639c5bb67502edf28e722dd1"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/50/5f/2a/505f2abe-950e-1462-95ef-3505c22cb33a/1963622745058_cover.jpg/1200x1200bf-60.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://i.scdn.co/image/ab67616d0000b273e87de16fd8ca422e16e82bd9"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musicartist').textContent = "Iron Master";
    document.getElementById('msgartist').textContent = "Danilo Trujillano, mais conhecido como Iron Master é um jovem de 22 anos que se tornou a mais nova revelação dentro da cena Geek no Brasil. Começou a fazer músicas com uma brincadeira entre amigos e após a segunda postagem, se tornou viral nas demais plataformas com a famosa frase 'Raça absoluta, além da consciência'. A partir deste momento, Iron começou a produzir músicas voltadas para o público Nerd/Geek, Gamer e Amante de desenhos, expandindo o nicho Geek, que até então, era voltado para a produção de músicas sobre animes. Suas músicas variam desde Rock à Jazz, contando com guitarras, batidas eletrônicas e muito mais. Sua música mais popular é o rap da animação 'Ben 10 Força Alienígena' lançada em 24 de Dezembro de 2020. Atualmente Iron tem uma linha de camisetas com as frases mais marcantes de suas músicas mais famosas e vem se aprimorando cada vez mais para abranger toda a comunidade. O canal Iron Master conta com mais de 1 milhão de inscritos e mais de 270 milhões de visualizações, recebendo feedbacks e comentários constantes do público da comunidade geek.";
    document.getElementById('musiclogo').src = "Material/Solução Absoluta   Murder Drones (Nightcore) - Iron Master.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    document.getElementById('artistimg').src = "https://yt3.googleusercontent.com/LbhsmbjV50pJngJrXoCPlwLNvh6dsNhSAepCZHGGL92Vexks7GxPuvR_eztGYW7-uJYiSa2C2w=s160-c-k-c0x00ffffff-no-rj"; // Foto do artista
    document.getElementById("lyrics").innerHTML = texto;
    ...
    document.getElementById('musicartist').textContent = "Iron Master";
    document.getElementById('msgartist').textContent = "Danilo Trujillano, mais conhecido como Iron Master é um jovem de 22 anos que se tornou a mais nova revelação dentro da cena Geek no Brasil. Começou a fazer músicas com uma brincadeira entre amigos e após a segunda postagem, se tornou viral nas demais plataformas com a famosa frase 'Raça absoluta, além da consciência'. A partir deste momento, Iron começou a produzir músicas voltadas para o público Nerd/Geek, Gamer e Amante de desenhos, expandindo o nicho Geek, que até então, era voltado para a produção de músicas sobre animes. Suas músicas variam desde Rock à Jazz, contando com guitarras, batidas eletrônicas e muito mais. Sua música mais popular é o rap da animação 'Ben 10 Força Alienígena' lançada em 24 de Dezembro de 2020. Atualmente Iron tem uma linha de camisetas com as frases mais marcantes de suas músicas mais famosas e vem se aprimorando cada vez mais para abranger toda a comunidade. O canal Iron Master conta com mais de 1 milhão de inscritos e mais de 270 milhões de visualizações, recebendo feedbacks e comentários constantes do público da comunidade geek.";
    document.getElementById('musiclogo').src = "https://images.genius.com/e7f144e6051f1c3240eb64e5cb75e559.1000x1000x1.png"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    document.getElementById('artistimg').src = "https://yt3.googleusercontent.com/LbhsmbjV50pJngJrXoCPlwLNvh6dsNhSAepCZHGGL92Vexks7GxPuvR_eztGYW7-uJYiSa2C2w=s160-c-k-c0x00ffffff-no-rj"; // Foto do artista
    document.getElementById("lyrics").innerHTML = texto;
...
"I feel fear for the very last time<br>";
    ...
    document.getElementById('musiclogo').src = "https://th.bing.com/th/id/OIP.skhw4HJD8MLCRx9N3LzOjAHaHa?rs=1&pid=ImgDetMain"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://i.scdn.co/image/ab67616d0000b2733a4d8ae3b8341d1ca816d874"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "https://lh3.googleusercontent.com/fQRVEW7qwddapvxKkUuOLotcuEjhpsoUnMxBDZeXfs7Cd08Yv7qbKoXOk5vyc-HrgisbFz02c-6t4sOG"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musiclogo').src = "Material/REINDEER - Dj Samir.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musicartist').textContent = "ChewieCatt";
    document.getElementById('msgartist').textContent = "Just someone making his way through life one song at a time...";
    document.getElementById('musiclogo').src = "https://lh3.googleusercontent.com/mt4uKXu87KcKrs-yXI0LhKvXiZNsOPx1kYh7HeU3IIe9MsFJESfz-bZowd99ExqAqFl3FJ7U_SUHBss"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    document.getElementById('artistimg').src = "https://i.scdn.co/image/ab6761610000e5eba57c71ff631d56e9cf418d73"; // Foto do artista
    document.getElementById("lyrics").innerHTML = texto;
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/8b/e9/cf/8be9cf88-a980-52c5-fef0-65070fdbd744/693887118366.jpg/1200x1200bf-60.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://cdn-images.dzcdn.net/images/cover/beeb846d621625fdbe093aabaad6a849/500x500.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://static.qobuz.com/images/covers/oc/4d/k00mfn8pk4doc_600.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musicartist').textContent = "LDRR";
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://images.genius.com/80a95640b6945c14bc152fde17cfd1e9.1000x1000x1.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    document.getElementById('artistimg').src = "https://i.scdn.co/image/ab6761610000e5ebce74c325cb07fc695be87d53"; // Foto do artista
    document.getElementById("lyrics").innerHTML = texto;
    ...
    document.getElementById('musicartist').textContent = "DJ Samir";
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://i1.sndcdn.com/artworks-6rEA9E6Vw65C-0-t500x500.png"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    document.getElementById('artistimg').src = "https://i.scdn.co/image/ab6761610000e5eb270d26c1be427fd625aa56dd"; // Foto do artista
    document.getElementById("lyrics").innerHTML = texto;
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://th.bing.com/th/id/OIP.vCfQwam30sgjnf7VCX6uxAAAAA?rs=1&pid=ImgDetMain"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/68/e3/44/68e344e5-411b-a6bb-5beb-85f5e93ec792/199066739167.jpg/800x800cc.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('musicartist').textContent = "DJ Samir";
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "Material/TAKEN - DJ Samir.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://i1.sndcdn.com/artworks-Rhg9prN2RWNf2PWz-NwNM0w-t500x500.jpg"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
    ...
    document.getElementById('msgartist').textContent = "";
    document.getElementById('musiclogo').src = "https://static.wikia.nocookie.net/pvzcc/images/2/2a/Pvzgw_soundtrack.jpg/revision/latest?cb=20210124221208&path-prefix=es"; // Foto da música
    document.getElementById('musicvideo').style.display = "block"; // Mostra o vídeo
    document.getElementById('musicvideo').querySelector('source').src = ""; // Vídeo da música
...
if (musicaTocando) {
    ...
    video2.pause();
    musicaTocando = false;
    btnTocar.textContent = "Continuar";
...
if (cartao.style.display === 'flex') {
    ...
    cartao2.style.right = '332px';
    cartao2.textContent = ">";
    bar.style.width = '68.5%';
...
function mudarFundo(musica) {
    ...
    } else if (musica === 'musica2') {
      urlFundo = ''; // Coloque o URL da imagem que você deseja para música2
    } else if (musica === 'musica3') {
      urlFundo = ''; // Coloque o URL da imagem que você deseja para música3
    } else if (musica === 'musica4') {
        urlFundo = ''; // Coloque o URL da imagem que você deseja para música3
    } else if (musica === 'musica5') {
        urlFundo = ''; // Coloque o URL da imagem que você deseja para música3
...
function carregarFundo() {
      ...
      if (bar.style.display === 'none') {
        document.getElementById('cardbtn').style.right = '-10px';
        document.getElementById('cardbtn').textContent = "<";
        cartao.style.display = 'none';
        bar.style.display = 'block';
        document.body.style.overflowY = 'hidden';
        searchbar.style.display = 'block';
        searchbar.style.width = '1250px';
        bar.style.width = '100%';
        musicas.style.display = 'block';
        playPauseBtn.style.display = 'block';
        button.style.display = 'block';
        ...
        playPauseBtn.style.bottom = "15px";
        content.style.display = 'block';
        music.style.display = 'none';
        video.style.display = 'none';
        content.style.maxWidth = '94%';
        volBar.style.width = '130px';
        volBar.style.top = '870px';
...
function loadMusicState() {
    ...
    if (savedState) {
        ...
        if (savedState.isPlaying) {
            ...
            document.getElementById('playPauseBtn').textContent = 'Continuar';
            document.getElementById('playPauseBtn').style.backgroundColor = '#520096';
